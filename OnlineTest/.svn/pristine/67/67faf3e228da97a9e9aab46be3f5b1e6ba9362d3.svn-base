		...
		<form class="form-horizontal" action="home.htm" method="post">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-pencil-square-o"></i> Question Updated Successfully</h3>
				</div>
				<div class="panel-body">
					<span><img src="./jsp/images/tickmark.png" alt="Error" class="img-circle" height="140" width="140"></span>
					<span>You have updated the Question Successfully. To view all questions from Question Bank please <i class="fa fa-hand-o-right fa-1x"></i><button class="btn btn-link" formaction="displayallquestions.htm">click here</button>.</span>
