...
<!-- <form name="comprehensionQuestionForm" method="post"> -->
<div class="form-group">
	<label for="qtype" class="col-sm-4 control-label"><spring:message
			code="onlinetest.addquestion.qtext" /></label>
	<div class="col-sm-6">
		<textarea name="qText" id="qTextId" class="form-control" rows="4"
			cols="50" draggable="false"
...
<div class="form-group">
	...
	<div id="parent" class="col-sm-6">
		<div id="div1" class="radio">
			<span id="span1">A</span><input type="radio" name="option"
				id="radio1" value="1" checked> <input class="form-control"
				type="text" name="1" id="txt1" placeholder="Enter option 1" /> <a
				style="width: 20px" class="glyphicon glyphicon-minus-sign"
				id="remove1" href="javascript:removeOption(1)"></a>
		</div>
		<div id="div2" class="radio">
			<span id="span2">B</span><input type="radio" name="option"
				id="radio2" value="2"> <input class="form-control"
				type="text" name="2" id="txt2" placeholder="Enter option 2" /> <a
				style="width: 20px" class="glyphicon glyphicon-minus-sign"
				id="remove2" href="javascript:removeOption(2)"></a>
		</div>
		<div id="div3" class="radio">
			<span id="span3">C</span><input type="radio" name="option"
				id="radio3" value="3"> <input class="form-control"
				type="text" name="3" id="txt3" placeholder="Enter option 3" /> <a
				style="width: 20px" class="glyphicon glyphicon-minus-sign"
				id="remove3" href="javascript:removeOption(3)"></a>
		</div>
		<div id="div4" class="radio">
			<span id="span4">D</span><input type="radio" name="option"
				id="radio4" value="4"> <input class="form-control"
				type="text" name="4" id="txt4" placeholder="Enter option 4" /> <a
				style="width: 20px" class="glyphicon glyphicon-minus-sign"
				id="remove4" href="javascript:removeOption(4)"></a>
		</div>
